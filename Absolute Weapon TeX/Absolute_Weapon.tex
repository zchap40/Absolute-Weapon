...
\includepdf[pages={1}, offset = -16.85 0.5]{7x10-cover.pdf}
...
\phantomsection
\addcontentsline{toc}{chapter}{PART I - \underline{The Weapon}}
\part{The Weapon}
...
\phantomsection
\addcontentsline{toc}{chapter}{PART II - \underline{Political Consequences}}
...
\phantomsection
\addcontentsline{toc}{chapter}{PART III - \underline{Control}}
\part{Control}
